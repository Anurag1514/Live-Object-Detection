...
# For color of the rectangle
# np.random.seed(1784537)
...
while True:
    ...
    # Binary Large Object (BLOB object) # increase the 0.007 and 130 value to get better results....
